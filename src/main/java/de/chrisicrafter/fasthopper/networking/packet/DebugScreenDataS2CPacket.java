package de.chrisicrafter.fasthopper.networking.packet;
...
public class DebugScreenDataS2CPacket {
    ...
    public DebugScreenDataS2CPacket(HopperData data) {
    ...
    public void handle(CustomPayloadEvent.Context context) {
        context.enqueueWork(() -> ClientDebugScreenData.set(HopperData.load(tag)));
    }
}
